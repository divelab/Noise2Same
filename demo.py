...
os.system("!wget -O parront.png https://i.imgur.com/zdji3xv.png")
...
gr.Interface(predict, "image", "image", examples=[["lion2.png"]], title=title, description=description).launch(share=True, debug=True)
